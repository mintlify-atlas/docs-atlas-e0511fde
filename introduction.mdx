...
description: "CollaboKeys is a free macOS app that lets multiple players share one keyboard to control any keyboard-driven game in real time over a local network."
---
